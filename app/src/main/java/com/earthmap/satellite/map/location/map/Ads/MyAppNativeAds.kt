...
class MyAppNativeAds {
    ...
    companion object {
        ...
        private fun loadNativeAd(mContext: Context, frameLayout: FrameLayout) {
            ...
            nativeAdLoader = MaxNativeAdLoader(MyAppAds.max_native_id, mContext)
            nativeAdLoader!!.setNativeAdListener(object : MaxNativeAdListener() {
                ...
                {
                    loadAdmobNativeAdPriority(mContext as Activity,frameLayout )
                }
        ...
        private fun createNativeAdView(mContext: Context): MaxNativeAdView
        {
            val binder: MaxNativeAdViewBinder =
                MaxNativeAdViewBinder.Builder(R.layout.gps_native_max_layout)
                ...
                builder.forNativeAd { unifiedNativeAd ->
                    ...
                    try {
                        ...
                        val adView =  //actually card view of fb ad
                            inflater.inflate(
                                R.layout.native_admob_native_custom_layout,
                                null
                            ) as NativeAdView
